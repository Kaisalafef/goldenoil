...
class CalanderDetails extends StatelessWidget {
  var data;

  CalanderDetails({super.key, required this.data});
        ...
        body: Container(
          ...
          children: [
            ...
            Container(
              ...
              child: Text(
                "the  name calander :${data["name calander"]}",
            ...
            Container(
              margin: const EdgeInsets.only(top: 20),
              child: Text(
                "Type calander :${data["type calander"]}",
                textAlign: TextAlign.center,
